...
function ServerStarter({ game, onBack }) {
  ...
  const unsupportedGame = game && game !== 'minecraft'

  return (
    <div className="App">
      <header>
        <h1>🎮 Arcade Cabinet</h1>
        <p>{unsupportedGame ? `${gameLabel} (Coming Soon)` : 'Minecraft Server Manager'} - Tunnel-First</p>
      </header>
      ...
      <main>
        ...
        {unsupportedGame && (
          <div className="message error">
            Only Minecraft is supported right now. Choose Minecraft from the menu to start a server.
          </div>
        )}
        ...
        <div className="config-section">
          ...
          <button
            onClick={startServer}
            disabled={loading || unsupportedGame}
